...
namespace UptimeMonitor.Tests.Controllers
{
    public class ComponentControllerTests
    {
        ...
        {
            _mockService.Setup(s => s.UpdateAsync(1, It.IsAny<ComponentCreateDto>())).ReturnsAsync(true);
        ...
        {
            _mockService.Setup(s => s.UpdateAsync(999, It.IsAny<ComponentCreateDto>())).ReturnsAsync(false);

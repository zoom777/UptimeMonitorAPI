...
namespace UptimeMonitor.API.Controllers
{
    ...
    public class ComponentController : ControllerBase
    {
        ...
        [HttpGet("by-service-system/{serviceSystemId}")]
        public async Task<ActionResult<IEnumerable<ComponentResponseDto>>> GetByServiceSystemId(int serviceSystemId)
        {
            var result = await _service.GetByServiceSystemIdAsync(serviceSystemId);
            return Ok(result);
        }
    }
}
